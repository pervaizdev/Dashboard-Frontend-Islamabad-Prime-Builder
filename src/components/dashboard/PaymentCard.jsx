      ...
      {displayStats.map((item, index) => {
        ...
        const cardContent = (
          <motion.div
            ...
            className={`group relative overflow-hidden rounded-2xl border border-primary/10 bg-white
    w-full min-h-[230px] p-6 flex flex-col justify-between
    transition-all duration-300 premium-border-glow
  ...
  `}
          >
            ...
            <div className="relative flex items-start justify-between gap-4">
              <h3 className="font-serif text-lg font-semibold text-neutral-700 leading-snug min-h-[58px]">
                {item.title}
              </h3>

              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-primary/10 group-hover:bg-primary/20 transition-colors duration-300">
