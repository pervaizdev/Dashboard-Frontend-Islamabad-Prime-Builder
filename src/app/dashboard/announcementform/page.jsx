  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="flex flex-col gap-8">
        {/* Header Section */}
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 text-center md:text-start">
          <div className="flex flex-col items-center md:items-start">
            <h1 className="text-3xl font-bold lg:text-5xl text-primary flex items-center justify-center md:justify-start gap-3">
              <Megaphone className="h-8 w-8 lg:h-10 lg:w-10 shrink-0" style={{ stroke: "url(#announcementGoldGreen)" }} />
              Announcements
            </h1>
            <p className="mt-2 text-sm md:text-base text-slate-500 max-w-xl mx-auto md:mx-0">
              Manage promotional banners and system announcements.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center md:justify-end gap-3 w-full md:w-auto">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 bg-[#123D32] text-[#E5C476] px-6 py-3.5 rounded-xl font-bold text-xs uppercase tracking-wider shadow-xl shadow-slate-900/10 transition-all transform hover:scale-105 active:scale-95 w-full sm:w-auto"
            >
        ...
        <div className="relative group">
          ...
          <input
            ...
            className="w-full bg-white rounded-2xl pl-12 pr-4 py-3 text-sm border-none outline-none focus:outline-none focus:ring-0 shadow-sm"
          />
        </div>
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-md bg-white rounded-[2.5rem] shadow-2xl overflow-hidden p-6 sm:p-8"
            ...
            >
              ...
              <button
                type="button"
                onClick={() => setIsModalOpen(false)}
                className="absolute right-6 top-6 sm:right-8 sm:top-8 rounded-full p-2 text-slate-400 hover:bg-slate-100 transition-all"
              >
                <X className="h-5 w-5" />
              </button>
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-6 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mt-0.5">
                      {editMode ? "Update banner details" : "Create a new banner"}
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4 mb-6">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50/50 border border-slate-100 rounded-2xl px-4 py-3 text-sm font-medium focus:outline-none focus:bg-white focus:border-slate-200 transition-all placeholder:text-slate-300"
                    />
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full bg-slate-50/50 border border-slate-100 rounded-2xl px-4 py-3 text-sm font-medium focus:outline-none focus:bg-white focus:border-slate-200 transition-all placeholder:text-slate-300 resize-none"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className="w-full bg-slate-50/50 border border-slate-100 rounded-2xl px-3.5 py-3 text-xs font-semibold focus:outline-none focus:bg-white focus:border-slate-200 transition-all"
                      />
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest flex items-center gap-1.5 px-1">
                ...
                <div className="flex gap-3 pt-2">
                  <button
                    type="button"
                    onClick={() => setIsModalOpen(false)}
                    className="flex-1 bg-slate-50 text-slate-600 py-3.5 rounded-2xl font-bold text-xs uppercase tracking-wider hover:bg-slate-100 transition-all"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    disabled={submitting}
                    className="flex-1 bg-[#123D32] text-[#E5C476] py-3.5 rounded-2xl font-bold text-xs uppercase tracking-wider shadow-lg shadow-[#123D32]/10 hover:bg-[#0C3027] transition-all flex items-center justify-center gap-2"
                  >
        ...
        {isDetailModalOpen && selectedAnnouncement && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              animate={{ scale: 1, opacity: 1, y: 0 }}
              exit={{ scale: 0.95, opacity: 0, y: 20 }}
              className="relative w-full max-w-lg bg-white rounded-[2.5rem] shadow-2xl overflow-hidden p-6 sm:p-10"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-[#c29e6d] via-[#d4af37] to-[#047857]" />
              ...
              <div className="mb-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  {isExpired(selectedAnnouncement.end_datetime) ? (
                    ...
                    <span className="px-3 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-emerald-50 text-emerald-500 border border-emerald-100">Active</span>
                  )}
                </div>
                <h3 className="text-xl sm:text-2xl font-bold text-[#123D32] leading-snug">{selectedAnnouncement.title}</h3>
              </div>

              <div className="space-y-6">
                <div>
                  <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-2 px-1">Description</label>
                  <p className="text-xs sm:text-sm font-medium text-slate-600 leading-relaxed bg-slate-50/50 p-4 rounded-2xl border border-slate-100">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100">
                    ...
                    <span className="text-xs font-bold text-slate-800 break-words">{formatDate(selectedAnnouncement.start_datetime)}</span>
                  </div>
                  <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100">
                    <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-1">Ends At</label>
                    <span className="text-xs font-bold text-slate-800 break-words">{formatDate(selectedAnnouncement.end_datetime)}</span>
                  </div>
                </div>
                ...
                {/* <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-slate-100">
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 bg-[#123D32] text-[#E5C476] py-3.5 px-4 rounded-xl font-bold text-xs uppercase tracking-wider shadow-md hover:bg-[#0C3027] transition-all"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 bg-rose-50 text-rose-600 border border-rose-100 py-3.5 px-4 rounded-xl font-bold text-xs uppercase tracking-wider hover:bg-rose-100 transition-all"
                  >
